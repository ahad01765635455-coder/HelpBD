...
as $$
  select h.id,h.service,h.name,h.phone,h.division,h.district,h.upazila,h.union_name,h.details,h.status,h.created_at
  from public.help_requests h
  where h.service in ('আর্থিক সহায়তা','খাদ্য ও প্রয়োজনীয় সামগ্রী','চিকিৎসা সহায়তা')
